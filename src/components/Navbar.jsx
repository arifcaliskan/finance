  ...
  return (
    <div className=" flex text-white justify-between items-center h-24    max-w-[1240px] mx-auto px-4">
      ...
      <div
        className={
          !nav
            ? "fixed left-0 top-0 border-r border-r-gray-700 h-full w-[60%] bg-[#000300] ease-in-out duration-500"
            : "fixed left-[-100%]  ease-in-out duration-500"
        }
      >
        <h1 className="w-full text-[#00df9a] font-semibold text-3xl m-4">
          REACT.
        </h1>
